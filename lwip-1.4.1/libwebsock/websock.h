...
//globals
extern /*pthread_mutex_t*/uint32_t global_alloc_free_lock;
...
void libwebsock_insert_into_thread_list(libwebsock_client_state *state, /*pthread_t*/uint32_t *tptr, enum WS_THREAD_TYPE type);
void libwebsock_shutdown(libwebsock_client_state *state);
void libwebsock_shutdown_after_send_cb(/*evutil_socket_t*/uint32_t fd, short what, void *arg);
...
#ifdef WEBSOCK_HAVE_SSL
void libwebsock_handle_accept_ssl(/*evutil_socket_t*/uint32_t listener, short event, void *arg);
#endif
